<%-- 
    Document   : Cart
    Created on : Jan 26, 2024, 10:07:36 PM
    Author     : PC
--%>
                ...
                <div class="row g-4 justify-content-end">
                    ...
                    <div class="col-sm-8 col-md-7 col-lg-6 col-xl-4">
                        <div class="bg-light rounded">
                            ...
                            <button class="btn border-secondary rounded-pill px-4 py-3 text-primary text-uppercase mb-4 ms-4" type="button">Order</button>
                        </div>
                    </div>
                </div>
            </div>
